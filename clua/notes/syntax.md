...
Behavior described is in the outer context unless otherwise specified. Several unary characters change that context in indicated ways.
...
`\ /` are being held onto while I mull over their utility. 
